...
function sendMessage(message, messagesArea, input) {
  if (!message.trim()) return;
  
  // Add user message
  addMessage(messagesArea, message, 'user');
  input.value = '';
  
  // Simulate AI response (replace with actual AI integration later)
  setTimeout(() => {
    addMessage(messagesArea, "I'm analyzing this video. This feature is coming soon!", 'ai');
  }, 1000);
}
